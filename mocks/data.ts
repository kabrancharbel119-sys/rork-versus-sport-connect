...
export const mockMatches: Match[] = [
  { id: 'match-1', sport: 'football', format: '5v5', type: 'friendly', status: 'open', homeTeamId: 'team-1', venue: mockVenues[1], dateTime: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000), duration: 90, level: 'advanced', ambiance: 'competitive', maxPlayers: 10, registeredPlayers: ['user-1', 'user-2', 'user-3'], createdBy: 'user-1', needsPlayers: true, location: { latitude: 5.3599, longitude: -4.0083, city: 'Abidjan', country: 'Côte d\'Ivoire', lastUpdated: new Date() }, createdAt: new Date() },
  { id: 'match-2', sport: 'football', format: '11v11', type: 'ranked', status: 'confirmed', homeTeamId: 'team-1', awayTeamId: 'team-2', venue: mockVenues[0], dateTime: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000), duration: 90, level: 'advanced', ambiance: 'competitive', maxPlayers: 22, registeredPlayers: [], createdBy: 'user-1', entryFee: 10000, prize: 100000, needsPlayers: false, createdAt: new Date() },
  { id: 'match-3', sport: 'basketball', format: '5v5', type: 'friendly', status: 'open', venue: mockVenues[2], dateTime: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000), duration: 60, level: 'intermediate', ambiance: 'casual', maxPlayers: 10, registeredPlayers: ['user-1'], createdBy: 'user-1', needsPlayers: true, location: { latitude: 5.3000, longitude: -3.9833, city: 'Abidjan', country: 'Côte d\'Ivoire', lastUpdated: new Date() }, createdAt: new Date() },
];
