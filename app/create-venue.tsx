...
export default function CreateVenueScreen() {
  ...
  const createMutation = useMutation({
    ...
    onError: (error: Error) => {
      Alert.alert('Erreur', error.message || 'Impossible de créer le terrain.');
    },
  });
  ...
  const pickVenuePhoto = async () => {
    if (Platform.OS !== 'web') {
      ...
      if (status !== 'granted') {
        if (!canAskAgain) {
          Alert.alert('Permission refusée', 'Autorisez l\'accès aux photos dans les réglages de votre téléphone.');
        } else {
      ...
      <View style={styles.container}>
        ...
        <SafeAreaView style={styles.safeArea}>
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Nouveau terrain</Text>
            <View style={{ width: 40 }} />
          </View>
          ...
          >
            ...
            >
              ...
              <TextInput
                ...
                placeholder="Ex: Stade Municipal de Cocody"
              ...
              <TextInput
                ...
                placeholder="Ex: Rue des Sports, Cocody"
                placeholderTextColor={Colors.text.muted}
              ...
              <TextInput
                style={styles.input}
                placeholder="Ex: contact@terrain.ci"
                placeholderTextColor={Colors.text.muted}
              ...
              <Text style={styles.hoursHint}>Configurez les horaires pour chaque jour. Désactivez un jour pour le marquer fermé.</Text>
              {formData.openingHours.map((day, idx) => (
              ...
              <TextInput
                style={[styles.input, styles.textArea]}
                placeholder="Ex: Chaussures à crampons interdites, pas de nourriture sur le terrain..."
                placeholderTextColor={Colors.text.muted}
              ...
              <View style={styles.switchRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.switchHint}>
                    Les réservations seront confirmées automatiquement si activé.
                  </Text>
                </View>
                <Switch
